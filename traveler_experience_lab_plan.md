...
6. ~~**파일럿 실행**~~ → ✅ **6세션 실측 완료 (2026-07-10)**. A′ 순 소요 중앙값 **1분 48초**(baseline 8:20 대비 −78%, 목표 −50% 상회) + 엣지 6·근거 6 유지, B′ 정확도 9/9. [기록 시트·판정](docs/pilot/pilot_sheet.md). ⚠ 자기시뮬레이션 조건 — **사람 PE 3명 재측정을 후속 게이트로 권장**(시트 caveat 4).
